...
public class LSB1ImplIntegrationTest {
    ...
    public void conceal() {
        ...
        lsb1Impl.conceal(toHide, carrierBmp);

        var expected = bmpFileIO.read(getResource("ladoLSB1.bmp"));
        assertArrayEquals(expected.getBytes(), carrierBmp.getBytes());
    }

    @Test
    public void reveal() {
        var carrierBmp = bmpFileIO.read(getResource("ladoLSB1.bmp"));
        var result = lsb1Impl.reveal(carrierBmp);
    ...
    public void invertible() {
        ...
        lsb1Impl.conceal(toHide, carrierBmp);
        var hidden = lsb1Impl.reveal(carrierBmp);
